...
public class CoordinateUtil {
    ...
    /**
     * J2000坐标系转地固坐标系 - 仅转换位置
     *
     * @param position J2000坐标系中的位置向量 (m)
     * @param date 转换时刻
     * @return 地固坐标系中的位置向量 (m)
     */
    public static Vector3D j2000ToFixed(Vector3D position, AbsoluteDate date) {
        Frame j2000 = FramesFactory.getEME2000();
        Frame itrf = FramesFactory.getITRF(IERSConventions.IERS_2010, true);
        return transformPosition(position, j2000, itrf, date);
    }
