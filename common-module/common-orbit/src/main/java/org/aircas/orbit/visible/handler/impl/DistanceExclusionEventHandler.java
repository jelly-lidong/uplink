...
public class DistanceExclusionEventHandler extends AbstractEventDetectorHandler {
    ...
    protected EventDetector createDetector(Propagator targetPropagator, List<TimeWindow> timeIntervals, TimeWinCallback winCallback) {
        ...
        return new DistanceExclusionDetector(targetPropagator, minDistance, maxDistance, maxIter, AdaptableInterval.of(maxCheck), threshold, createDefaultHandler(timeIntervals, winCallback));
    }
