package org.aircas.orbit.visible.event;
...
public abstract class EventDetectorCalculator {

    @Getter
    private static final List<EventDetectorCalculator> eventDetectorCalculators = new ArrayList<>();

    public static void add(EventDetectorCalculator eventDetectorCalculator) {
