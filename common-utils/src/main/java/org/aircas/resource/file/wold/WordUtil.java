package org.aircas.resource.file.wold;
...
public class WordUtil {
  ...
  public static void main(String[] args) throws IOException, InvalidFormatException {
    ...
    Resource resource = new ClassPathResource("/file/pdai-guli.png");
    InputStream stream = Files.newInputStream(resource.getFile().toPath());
    ...
    File file = new File("/file/table.docx");
    file.createNewFile();
