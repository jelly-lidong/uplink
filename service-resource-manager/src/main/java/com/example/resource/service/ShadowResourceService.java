...
public interface ShadowResourceService {
     ...
     * @param startTime 开始时间
     * @param endTime 结束时间
     * @return 可用设备，如果没有则返回null
     */
    GroundEquipment findAvailableShadowResource(TaskInfo taskInfo, LocalDateTime startTime, LocalDateTime endTime);
     ...
     * @return 是否支持影子模式
     */
    boolean isSupportShadowMode(GroundEquipment equipment);
     ...
     * @return 是否可用
     */
    boolean isShadowResourceAvailable(GroundEquipment equipment, LocalDateTime startTime, LocalDateTime endTime);
     ...
     * @return 任务调度信息
     */
    TaskSchedule allocateShadowResource(TaskInfo task, GroundEquipment equipment, LocalDateTime startTime, LocalDateTime endTime);
