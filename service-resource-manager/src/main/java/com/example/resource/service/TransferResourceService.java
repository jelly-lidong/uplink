...
public interface TransferResourceService {
     ...
     * @return 可转让的资源列表
     */
    List<GroundEquipment> findTransferableResources(TaskInfo taskInfo, LocalDateTime startTime, LocalDateTime endTime);
     ...
     * @return 负载率(0-1)
     */
    double getEquipmentLoad(Long equipmentId, LocalDateTime startTime, LocalDateTime endTime);
} 